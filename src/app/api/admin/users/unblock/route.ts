...
export async function POST(req: NextRequest) {
  try {
    ...
    await sendPushNotification(userId, { title: 'Account Unblocked', body: 'Your account has been restored. You can now sign in and use Habesha Exchange normally.' }).catch(() => {})
